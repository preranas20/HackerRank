...
public class Solution {
    ...
    static void plusMinus(int[] arr) {
     ...
     System.out.println(df.format((float)sumPlus/arr.length));
     System.out.println(df.format((float)sumMinus/arr.length));
     System.out.println(df.format((float)sumZero/arr.length));
    }
