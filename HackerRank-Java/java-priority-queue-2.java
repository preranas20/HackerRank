...
class Priorities{
    // Priorties(){}
     PriorityQueue<Student> priorityQueue = new PriorityQueue<Student>(12,new StudentComparator());
     
     List<Student> getStudents(List<String> events){
        for(String event:events){ 
         String[] studentData = event.split(" ");
         if(studentData[0].equals("ENTER")){
             Student student = new Student(studentData[1],Double.valueOf(studentData[2]),Integer.valueOf(studentData[3]));
